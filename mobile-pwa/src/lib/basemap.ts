...
//
// The PoC ships without any paid key, so the default renders token-free. Carto
// Positron is a clean light OSM raster basemap that matches the dashboard theme.
//
