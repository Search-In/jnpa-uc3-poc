...
class VesselCallRepository:
    ...
    async def persist(self, records: Sequence[Mapping[str, Any]], *, filename: str,
        ...
        # the same bytes from the API and from a manual dump each land once.
...
INSERT INTO core.vessel_call
    (vcn, via_no, imo_no, vessel_name, voyage_no, rotation_no, purpose, status,
     eta, etb, etd, ata, atd, atc, source_note, data_origin)
VALUES
    (:vcn, :via_no,
...
_EVENT_INSERT = """
INSERT INTO core.vessel_call_event (call_id, event_type, event_ts, data_origin)
VALUES (:call_id, :event_type, :event_ts, :data_origin)
