...
// Calcite dark design system. defineCustomElements() registers the Calcite web
...
// ArcGIS Maps SDK config + dark theme chrome (attribution / zoom widgets).
...
// the whole tree (including portalled Calcite overlays) renders dark.
